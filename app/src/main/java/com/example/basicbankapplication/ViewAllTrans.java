...
import com.example.basicbankapplication.TransactionHistoryAdapter;
import com.example.basicbankapplication.R;

import java.text.NumberFormat;
import java.util.ArrayList;
public class ViewAllTrans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_trans);
        // Get TextView
