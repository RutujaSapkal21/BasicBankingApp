...
public class ViewUserDetails extends AppCompatActivity {
    ...
    private void enterAmount() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(ViewUserDetails.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mAmount.getText().toString().isEmpty()) {
                    ...
                    Intent intent = new Intent(ViewUserDetails.this, SendToUserList.class);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(ViewUserDetails.this);
